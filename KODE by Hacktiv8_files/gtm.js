...
Y.a.gaawc=["google"],function(){function a(b,c,d){for(var e=0;e<c.length;e++)b.hasOwnProperty(c[e])&&(b[c[e]]=d(b[c[e]]))}(function(b){Y.__gaawc=b;Y.__gaawc.b="gaawc";Y.__gaawc.g=!0;Y.__gaawc.priorityOverride=10})(function(b){var c=String(b.vtp_measurementId),d=bn(b.vtp_fieldsToSet,"name","value")||{};if(d.hasOwnProperty(C.la)||b.vtp_userProperties){var e=d[C.la]||{};m(bn(b.vtp_userProperties,"name","value"),e);d[C.la]=e}a(d,C.ze,function(f){return Ja(f)});a(d,C.Be,function(f){return Number(f)});
d.send_page_view=b.vtp_sendPageView;Fk(d,c);I(b.vtp_gtmOnSuccess)})}();
Y.a.gaawe=["google"],function(){function a(c,d,e){for(var f=0;f<d.length;f++)c.hasOwnProperty(d[f])&&(c[d[f]]=e(c[d[f]]))}function b(c,d,e){var f={id:"transaction_id",revenue:"value",list:"item_list_name"},h={click:C.Vd,detail:C.Da,add:C.hb,remove:C.ib,checkout:C.Sa,checkout_option:"checkout_option",purchase:C.sa,refund:C.jb},k={},l=function(t,n){k[t]||(k[t]=n)},q=function(t,n,u){u=void 0===u?!1:u;if(t){k.items=k.items||[];for(var v={},x=0;x<t.length;v={Pa:v.Pa},x++)v.Pa={},Ha(t[x],function(w){return function(z,
A){u&&"id"===z?w.Pa.promotion_id=A:u&&"name"===z?w.Pa.promotion_name=A:w.Pa[z]=A}}(v)),k[C.S].push(v.Pa)}if(n)for(var y in n)f.hasOwnProperty(y)?l(f[y],n[y]):l(y,n[y])},r;"dataLayer"===c.vtp_getEcommerceDataFrom?(r=te(c.vtp_gtmEventId,"eventModel"))||(r=te(c.vtp_gtmEventId,"ecommerce")):r=c.vtp_ecommerceMacroData;if($a(r)){for(var p in r)r.hasOwnProperty(p)&&("currencyCode"===p?l("currency",r.currencyCode):"impressions"===p&&d===C.Tb?q(r.impressions,null):"promoClick"===p&&d===C.Wd?q(r.promoClick.promotions,
r.promoClick.actionField,!0):"promoView"===p&&d===C.Xd?q(r.promoView.promotions,r.promoView.actionField,!0):h.hasOwnProperty(p)?d===h[p]&&q(r[p].products,r[p].actionField):k[p]=r[p]);m(k,e)}}(function(c){Y.__gaawe=c;Y.__gaawe.b="gaawe";Y.__gaawe.g=!0;Y.__gaawe.priorityOverride=0})(function(c){var d=String(c.vtp_measurementIdOverride||c.vtp_measurementId),e=String(c.vtp_eventName);if("_"===e.charAt(0))I(c.vtp_gtmOnFailure);else{var f={};c.vtp_sendEcommerceData&&(0<=C.Ae.indexOf(e)||"checkout_option"===
e)&&b(c,e,f);m(bn(c.vtp_eventParameters,"name","value"),f);if(f.hasOwnProperty(C.la)||c.vtp_userProperties){var h=f[C.la]||{};m(bn(c.vtp_userProperties,"name","value"),h);f[C.la]=h}np(f);a(f,C.ze,function(k){return Ja(k)});a(f,C.Be,function(k){return Number(k)});Ek(e,f,d);I(c.vtp_gtmOnSuccess)}})}();
