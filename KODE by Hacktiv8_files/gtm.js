...
Z.a.gaawc=["google"],function(){function a(b,c,d){for(var e=0;e<c.length;e++)b.hasOwnProperty(c[e])&&(b[c[e]]=d(b[c[e]]))}(function(b){Z.__gaawc=b;Z.__gaawc.b="gaawc";Z.__gaawc.g=!0;Z.__gaawc.priorityOverride=10})(function(b){var c=String(b.vtp_measurementId),d=bn(b.vtp_fieldsToSet,"name","value")||{};if(d.hasOwnProperty(C.la)||b.vtp_userProperties){var e=d[C.la]||{};m(bn(b.vtp_userProperties,"name","value"),e);d[C.la]=e}a(d,C.se,function(f){return Ha(f)});a(d,C.ue,function(f){return Number(f)});
d.send_page_view=b.vtp_sendPageView;Gk(d,c);I(b.vtp_gtmOnSuccess)})}();
Z.a.gaawe=["google"],function(){function a(c,d,e){for(var f=0;f<d.length;f++)c.hasOwnProperty(d[f])&&(c[d[f]]=e(c[d[f]]))}function b(c,d,e){if(c.vtp_sendEcommerceData&&0<=C.te.indexOf(d)){var f;"dataLayer"===c.vtp_getEcommerceDataFrom?f=lm("eventModel",2):f=c.vtp_ecommerceMacroData;bb(f)&&m(f,e)}}(function(c){Z.__gaawe=c;Z.__gaawe.b="gaawe";Z.__gaawe.g=!0;Z.__gaawe.priorityOverride=0})(function(c){var d=String(c.vtp_measurementIdOverride||c.vtp_measurementId),e=String(c.vtp_eventName);if("_"===e.charAt(0))I(c.vtp_gtmOnFailure);
else{var f={};b(c,e,f);m(bn(c.vtp_eventParameters,"name","value"),f);if(f.hasOwnProperty(C.la)||c.vtp_userProperties){var h=f[C.la]||{};m(bn(c.vtp_userProperties,"name","value"),h);f[C.la]=h}Xo(f);a(f,C.se,function(k){return Ha(k)});a(f,C.ue,function(k){return Number(k)});Fk(e,f,d);I(c.vtp_gtmOnSuccess)}})}();
...
G("contentGroup",t);G("dimension",p);G("metric",u);var W={};h(y,W,!1)&&A("set",W);var ca;n.vtp_enableLinkId&&A("require","linkid","linkid.js");A("set","hitCallback",function(){var oa=y&&y.hitCallback;xa(oa)&&oa();n.vtp_gtmOnSuccess()});if("TRACK_EVENT"==n.vtp_trackType){}else if("TRACK_SOCIAL"==n.vtp_trackType){}else if("TRACK_TRANSACTION"==n.vtp_trackType){}else if("TRACK_TIMING"==n.vtp_trackType){}else if("DECORATE_LINK"==n.vtp_trackType){}else if("DECORATE_FORM"==n.vtp_trackType){}else if("TRACK_DATA"==
